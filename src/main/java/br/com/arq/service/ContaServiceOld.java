...
public class ContaServiceOld {
	...
	private void executarTransferencia(String origem, String destino, BigDecimal valor) {
		...
		Facts facts = new Facts()
 		...
 		ContaRules.saldoInsuficiente().execute(facts);
	...
	@Transactional
	private void executarTransferenciaPatter(String origem, String destino, BigDecimal valor) {
